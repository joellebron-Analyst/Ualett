...
st.set_page_config(page_title="On Time Report", layout="wide")
st.markdown('# On Time Dashboard')
...
nombre = st.sidebar.selectbox(
    'Nombre:', historic.loc[
        ...
        (historic['Status'] == 'On Time'), 'Full Name'
    ].unique())
